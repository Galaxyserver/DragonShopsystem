...
if (message.content.startsWith(prefix + 'help')) {
	...
	`=-=-=-=-=-= 🌍 Public Commands - اوامر عامة 🌍 =-=-=-=-=-=
     ✴ Dsug =====> To Suggest | لعمل اقتراح
    ✴ Did ======> To Show Your ID | ايدي حسابك
    ✴ Dping ====> Ping Of Bot | بنج حك البوت
    ✴ Dallbots => Show All Bots In The Server | لاضهار جميع البوتات
    ✴ Dbot =====> Information Of The Bot | معلومات البوت
    ✴ Dserver ==> Information Of The Server | معلومات السيرفر
    ✴ Dcount ===> Member Count | عدد الاشخاص في السيرفر
    ✴ Dcal =====> To Calculate | اله لحاسبة 
    ✴ Dtag =====> To Tag A Word | لعمل تاق لكلمة 
    ✴ Drooms ===> Show Rooms Of Server | اضهار الرومات الي في السيرفر
    ✴ Dza5 =====> To decorate Some Word | لزخرفة الكلمات
    ✴ Droles ===> Show Roles Of The Server | اضهار الرانكات
    ✴ Demojis ==> Emoji Of Server | ايموجيات السيرفر   
    ✴ Dsay =====> The Bot Say Any Thing | تكرار اي شي كتبتو
    ✴ Dimage ===> To Show Image Of Server | لاضهار صورة السيرف 
    ✴ Dcontact => To Contact Owners Bot | مراسلة صاحب البوت
    ✴ Dinvite \ -inv => Invite Bot | لدعوة البوت
    ✴ Dembed ===> To Embed | لتكرار اي شي كتبتو بطريقة حلوة
    ✴ Davatar ==> Your Avatar | صورتك الشخصية
    ✴ Dsupport => Server Support | سيرفر الدعم الفني
     ===========================================================
      React With ▶ To See Admins Commands`,
	`=-=-=-=-=-= 🔧  Admin Commands - اوامر ادارية 🔧 =-=-=-=-=-=
    ❖ Dmove @user => Move User To Your Room Voice | لسحب الشخص الى روومك
    ❖ Dmvall => Move All To Your Room Voice | لسحب الجميع الي روومك
    ❖ Dbc => Broadcast | رسالة جماعية الى كل اعضاء السيرفر
    ❖ Drole @user <rank> => Give User Rank | لأعطاء رتبة لعضو معين
    ❖ Droleremove @user <rank> => remove Rank From User | لازالة الرتبة من شخص معين
    ❖ Drole all <rank> => Give All Rank | لأعطاء رتبة للجميع
    ❖ Drole humans <rank> => Give Humans Rank | لأعطاء رتبة للاشخاص فقط
    ❖ Drole bots <rank> => Give Bots Rank | لأعطاء رتبة لجميع البوتات
    ❖ Dhchannel => Hide Channel | اخفاء الشات
    ❖ Dschannel => Show The Hidden Channel | اضهار الشات المخفية
    ❖ Dclr <numbr> => Clear Chat With Number | مسح الشات بعدد
    ❖ Dclear => Clear Chat | مسح الشات
    ❖ Dmute @user <reason> => Mute User | اعطاء العضو ميوت لازم رتبة <Muted>
    ❖ Dunmute @user => Unmute User | لفك الميوت عن الشخص 
    ❖ Dkick @user <reason> => Kick User From Server | طرد الشخص من السيرفر
    ❖ Dban @user <reason> => Ban User From Server | حضر الشخص من السيرفر
    ❖ Dmutechannel => Mute Channel | تقفيل الشات
    ❖ Dunmutechannel => Unmute Channel | فتح الشات
    ❖ Ddc => Delete All Rooms |  مسح كل الرومات
    ❖ Ddr => Delete All Rank <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات
    ❖ Dccolors <number> => Create Colors | ينشا لك الوان مع كم الوان تبي
    ❖ Dkv @user => Voice Kick | يطرد شخص من الرووم
    ❖ Dvonline => Create Channel Voice Online | يسوي رووم فويس اونلاين
     ===========================================================
    ...
    💠 Dxo @user => Game XO | لعب اكس او
    💠 Drps => Rock & Paper & Scissors | لعبة حجر ورقة مقص
    💠 Dslots => Game Of Fruits | لعبة الفواكه
    💠 Dmarry @user => لعبة الزواج
    💠 Dspeed => لعبة سرعة كتابة 
    💠 Dلعبة فكك <= فكك
    💠 Dلعبة عواصم <= عواصم
    💠 Dالبوت يعطيك نصائح <= هل تعلم
    ...
    ❖ Dplay => لتشغيل أغنية برآبط أو بأسم
    ❖ Dskip => لتجآوز الأغنية الحآلية
    ❖ Dpause => إيقآف الأغنية مؤقتا
    ❖ Dresume => لموآصلة الإغنية بعد إيقآفهآ مؤقتا
    ❖ Dvol => لتغيير درجة الصوت 100 - 0
    ❖ Dstop => لإخرآج البوت من الروم
    ❖ Dnp => لمعرفة الأغنية المشغلة حآليا
    ❖ Dqueue => لمعرفة قآئمة التشغيل
...
client.on('message', message => {
   if (message.content.startsWith("Did")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
...
client.on('message', message => {
      if(message.content.startsWith ("Dmarry")) {
      if(!message.channel.guild) return message.reply('** This command only for servers **')
